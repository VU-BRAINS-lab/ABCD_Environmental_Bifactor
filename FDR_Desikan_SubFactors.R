...
modelResults <- readModels("Environmental_Bifactor_SEMAnalysisCT_SecondOrder_Subfactors_Revised.out") 
...
# Find the index of CT regression results for each factor
...
# Find the stat estimation/se of CT regression results for each factor
...
ses_est <- standardizedResults$est[reg_ses]
...
# BrainR2<-R2[which(R2[,1]=="CT_1"):which(R2[,1]=="CT_68"),2]
